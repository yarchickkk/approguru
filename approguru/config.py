...
RED_BOLD = "\033[1;31m"
RESET = "\033[0m"
FETCHED_DATA_POINTS = 450  # candels requested from geckoterminal API
INITIAL_SEARCH_REGION = 350  # candels considered for search by deafault (can be extended during execution)