...
RED_BOLD = "\033[1;31m"
RESET = "\033[0m"
FETCHED_DATA_POINTS = 250  # candles requested from geckoterminal API
INITIAL_SEARCH_REGION = 200  # candles considered for search by deafault (can be extended during execution)
SEED = 123456
TARGETS_FIT = "close"
